  ...
  return (
    <section className="shell py-8">
      <div className="rounded-[var(--radius-card)] bg-drikon-gradient text-white px-6 py-10 sm:px-10 md:px-14 md:py-12
        ...
        <Link
          href={buttonHref}
          className="self-start md:self-auto inline-flex items-center gap-2 min-h-[45px] rounded-[var(--radius-ctl)] bg-[color:var(--accent)] px-6 py-3 font-bold text-[color:var(--accent-fg)]
