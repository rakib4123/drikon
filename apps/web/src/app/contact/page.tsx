  ...
  return (
    <section className="max-w-3xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        ...
        <h1 className="display text-4xl md:text-5xl">Contact {brand}</h1>
        <p className="mt-4 text-[color:var(--fg-muted)] max-w-lg mx-auto">
          Questions about an order, a product, or anything else — reach out and a real person will get back to you.
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="card flex items-start gap-4">
          ...
          <div>
            ...
            <div className="text-sm text-[color:var(--fg-muted)] mt-1">Usually within one business day.</div>
          </div>
        </div>
      </div>
      ...
      <p className="mt-14 text-center text-sm text-[color:var(--fg-muted)]">
        Looking for order status, shipping timelines, or our return policy? See{' '}
